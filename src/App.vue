<template>
  <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
    <router-link class="navbar-brand col-sm-3 col-md-2 mr-0" to="/"
      >ООО Рога и копыта</router-link
    >
    <input
      class="form-control form-control-dark w-100 m-1 p-1"
      type="text"
      placeholder="Поиск"
      aria-label="Поиск"
    />
          ...
          <ul class="nav flex-column">
            <li class="nav-item">
              <router-link class="nav-link active" to="/">
                ...
                Dashboard <span class="sr-only">(тек.)</span>
              </router-link>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <router-link class="nav-link" to="/integration">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
